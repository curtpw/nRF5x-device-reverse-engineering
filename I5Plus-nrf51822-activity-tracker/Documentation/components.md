...
|------------|---------------------|---------------------|---------------------|---------------------|-|-|-|
| dark green   | T160 | MhLJ || unknown| unknown||unknown|
| light green  | 16A1Y | 1532 ||unknown|unknown|in the linked forum posts below belived to be an Atmel ATmega16U2 (I don't see how that should workout givven the label and the different pinout|unknown|
...
| yellow       | A524 ||| unknown| unknown||unknown|
