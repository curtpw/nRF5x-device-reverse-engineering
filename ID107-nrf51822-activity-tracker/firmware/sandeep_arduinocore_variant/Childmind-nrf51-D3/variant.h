...
#ifndef _CHILDMIND_NRF51_D3_
#define _CHILDMIND_NRF51_D3_
...
#define PIN_SPI1_MISO         (15) //not used
#define PIN_SPI1_MOSI         (14)
#define PIN_SPI1_SCK          (16)

#define PIN_SPI2_MISO         (15) //not used
#define PIN_SPI2_MOSI         (14)
#define PIN_SPI2_SCK          (16)
