...
if(debug_msg){
    ...
    if(central){ // if a central is connected to peripheral
       ...
       const unsigned char tempTransmitCharArray[20] = {
            (uint8_t)( int(deltaWave * 100) ),  
            (uint8_t)( int(deltaWave * 10000) - int(deltaWave * 100) ),
            (uint8_t)( int(thetaWave * 100) ),  
            (uint8_t)( int(thetaWave * 10000) - int(thetaWave * 100) ),
            (uint8_t)( int(alphaWave * 100) ),  
            (uint8_t)( int(alphaWave * 10000) - int(alphaWave * 100) ),
            (uint8_t)( int(betaWave * 100) ),  
            (uint8_t)( int(betaWave * 10000) - int(betaWave * 100) ),
            (uint8_t)( int(EMGWave * 100) ),  
            (uint8_t)( int(EMGWave * 10000) - int(EMGWave * 100) ),
            (uint8_t)( int(deltaWave2 * 100) ),  
            (uint8_t)( int(deltaWave2 * 10000) - int(deltaWave2 * 100) ),
            (uint8_t)( int(thetaWave2 * 100) ),  
            (uint8_t)( int(thetaWave2 * 10000) - int(thetaWave2 * 100) ),
            (uint8_t)( int(alphaWave2 * 100) ),  
            (uint8_t)( int(alphaWave2 * 10000) - int(alphaWave2 * 100) ),
            (uint8_t)( int(betaWave2 * 100) ),  
            (uint8_t)( int(betaWave2 * 10000) - int(betaWave2 * 100) ),
            (uint8_t)( int(EMGWave2 * 100) ),  
            (uint8_t)( int(EMGWave2 * 10000) - int(EMGWave2 * 100) ),
        }; 
